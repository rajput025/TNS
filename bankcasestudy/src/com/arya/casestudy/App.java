...
public class App {
	...
	public static void main(String[] args) {
		...
		BankAccount savingAccount = factory.getNewSavingAccount(1001, "Ankit", 1000, true);
		
		savingAccount.withdraw(400);
		savingAccount.deposit(100);
		
		BankAccount currentAccount = factory.getNewCurrentAccount(9001, "Hardik", 2000, 1000);
